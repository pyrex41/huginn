...
nondefault socket. The switch defaults to false.

The package makes tmux available to `huginn`. Peers and credentials belong
in the user's config, not the Nix store.
